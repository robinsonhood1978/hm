        ...
        <b-row>
          ...
          <b-col cols="12">
            ...
            >
              ...
              >
                <b-form-textarea
                  v-model="profile.church_experience"
          ...
          <b-col cols="12">
            ...
            >
              <b-form-textarea
                v-model="profile.personal_testimony"
...
export default {
  ...
  computed: {
    ...
    letterTemplate() {
      return `${this.$store.state.ship2u.apiHost}/public/2022_rev.docx`
    },
    edit() {
