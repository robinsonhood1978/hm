...
export default {
  ...
  computed: {
    step1() {
      ...
      const answerStep1 = this.$store.state.ship2u.evaluation.answer.slice(0, 7)
      const stdAswStep1 = this.$store.state.ship2u.course?.standardAnswer.slice(0, 7)

      obj.forEach((o, i) => {
        // eslint-disable-next-line no-return-assign, no-param-reassign
        o.answer = answerStep1[i]
        // eslint-disable-next-line no-param-reassign
        o.rightAnswer = stdAswStep1[i]
        // eslint-disable-next-line no-param-reassign
        o.variant = (o.answer === stdAswStep1[i]) ? 'success' : 'danger'
      })
      return obj
    },
    step2() {
      ...
      const answerStep2 = this.$store.state.ship2u.evaluation.answer.slice(7, 14)

      const stdAswStep2 = this.$store.state.ship2u.course?.standardAnswer.slice(7, 14)

      obj.forEach((o, i) => {
        // eslint-disable-next-line no-return-assign, no-param-reassign
        o.answer = answerStep2[i]
        // eslint-disable-next-line no-param-reassign
        o.rightAnswer = stdAswStep2[i]
        // eslint-disable-next-line no-param-reassign
        o.variant = (o.answer === stdAswStep2[i]) ? 'success' : 'danger'
      })
      return obj
    },
    step3() {
      ...
      const answerStep3 = this.$store.state.ship2u.evaluation.answer.slice(14)
      const stdAswStep3 = this.$store.state.ship2u.course?.standardAnswer.slice(14)

      obj.forEach((o, i) => {
        // eslint-disable-next-line no-return-assign, no-param-reassign
        o.answer = answerStep3[i]
        // eslint-disable-next-line no-param-reassign
        o.rightAnswer = stdAswStep3[i]
        // eslint-disable-next-line no-param-reassign
        o.variant = (o.answer === stdAswStep3[i]) ? 'success' : 'danger'
      })
      return obj
    },
  },
